...
public class SyncIncrOrdersController {
	...
	public @ResponseBody String writeLog(HttpServletRequest request) {
		...
		try {
			...
			// final String message = request.getParameter("message");//TODO 临时代码
			final String message = "{\"businessSystemId\":3,\"orderId\":300315525,\"preStatus\":\"V\",\"status\":\"E\",\"changeEvent\":[\"BaseOrderStatusChange\"],\"orderTimestamp\":\"2016-01-07 10:02:34:153\",\"payment\":\"D\",\"checkInDate\":\"2016-01-05 00:00:00\",\"checkOutDate\":\"2016-01-12 00:00:00\",\"roomCount\":1,\"sHotelId\":\"90000332\",\"additionalStatus\":1073750272,\"addtionalStatusI\":1073741824}";
