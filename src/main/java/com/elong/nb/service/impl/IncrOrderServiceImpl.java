...
public class IncrOrderServiceImpl implements IIncrOrderService {
	...
	public void handlerMessage(final String message) {
		...
		String reqData = "{ \"orderId\":%d,\"fields\":\"sumPrice,status,roomCount,proxy,orderTimestamp,orderId,orderFrom,checkOutDate,checkInDate,cardNo\" }";
		...
		String retcode = (String) jsonObj.get("retcode");
	...
	public Map<String, Object> convertMap(Map<String, Object> sourceMap) {
		...
		try {
			String orderTimestamp = (String) targetMap.get("orderTimestamp");
			Date ChangeTime = DateUtils.parseDate(orderTimestamp, new String[] { "yyyy-MM-dd HH:mm:ss:SSS", "yyyy-MM-dd HH:mm:ss" });
		...
		targetMap.put("OrderId", targetMap.get("orderId"));
		targetMap.put("Status", targetMap.get("status"));
		try {
			String checkInDate = (String) targetMap.get("checkInDate");
		...
		try {
			String checkOutDate = (String) targetMap.get("checkOutDate");
		...
		targetMap.put("TotalPrice", targetMap.get("sumPrice"));
		targetMap.put("NumberOfRooms", targetMap.get("orderTimestamp"));
		targetMap.put("CardNo", targetMap.get("cardNo"));
		targetMap.put("OrderFrom", targetMap.get("orderFrom"));
		targetMap.put("ProxyId", targetMap.get("proxy"));
